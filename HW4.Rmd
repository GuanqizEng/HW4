...
date: "Fill in Due Date From Sakai"
output:
...
* Try problem 4 - 6 prior to class Monday so that you will be prepared to ask additional questions about simulation and working with Poisson/Negative Binomial models. 

* Complete write up through problem 9 over the break/after break.  Attempt problem 9 prior to Lab Friday.

* Finish write up and turn in on Monday. Please let us know if there are problems with missing packages for wercker as you go so that you have a passing badge.  Remove any instructions like this and above to clean up the presentation.
